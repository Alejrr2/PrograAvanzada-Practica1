...
namespace Practica1._2.Controllers
{
        ...
        using (var context = new AlaPastaDatabaseEntities())
        {
            ...
            foreach (var item in datos)
            {
                empleado.Add(new Empleado
                {
                    ...
                    NombreRol = item.tRoles.NombreRol,
    ...
    {
        using (var context = new AlaPastaDatabase2Entities())
        {
            // buscar el empleado                
    ...
    public ActionResult CrearEmpleado(Empleado model)
    {
        using (var context = new AlaPastaDatabaseEntities()) //definir la base de datos 
        {
            ...
            tabla.ConsecutivoRol = model.ConsecutivoPuesto;
    ...
    private void CargarRoles()
    {
        using (var context = new AlaPastaDatabaseEntities())
        {
            var datos = context.tRoles.ToList();
